            ...
            <div className=' flex flex-wrap p-5 bg-black text-white justify-evenly'>
                ...
                <motion.div
                    ...
                    <motion.p
                        ...
                        animate={{ opacity: 1 }}
                        transition={{ ease: "easeInOut", duration: 3 }}
                        className="mt-4 font-medium">COLCON AI is an advanced artificial intelligence platform designed to revolutionize communication. It empowers users with cutting-edge natural language processing capabilities, streamlining interactions and enhancing productivity.</motion.p>
                </motion.div>
